//
// Mandelbrot Fractal using Compute Shader
//
// reference
...
bool cViewer::OnInit()
{
	...
	bool result = false;
	result = m_computeShader.Create(renderer, "./fractal.cso");
	...
	const uint GradientTexels[8] = { 0xFF000040, 0xFF000080, 0xFF0000C0, 0xFF0000FF, 0xFF0040FF, 0xFF0080FF, 0xFF00C0FF, 0xFF00FFFF };
